  ...
  return (
    <div className="mb-10">
      ...
      <div className="mb-10 pt-6" style={{ borderTop: "1px solid #1A1A1A" }}>
        <p className="text-sm leading-relaxed mb-3" style={{ color: "#5A5040", fontStyle: "italic", maxWidth: "520px" }}>
          {t.advisorIntro}
        </p>
        <p className="text-xs leading-relaxed" style={{ color: "#3A3A3A", maxWidth: "520px" }}>
      ...
      {showIntro ? (
        <div className="flex-1 flex items-center justify-center px-6 py-12">
          <div className="w-full max-w-2xl">
            ...
            {sectionIdx === 0 && (
              <div className="mb-8 px-4 py-3" style={{ border: "1px solid #1E1E1E", background: "rgba(139,115,85,0.04)" }}>
    ...
    <div className="min-h-screen" style={{ background: "#0D0D0D", fontFamily: "Georgia, serif" }}>
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-16">
          ...
          {/* Results disclaimer */}
          <div className="mt-6 px-4 py-3 max-w-lg mx-auto" style={{ border: "1px solid #1A1A1A", background: "rgba(139,115,85,0.03)" }}>
            <p className="text-xs leading-relaxed" style={{ color: "#3A3A3A" }}>{t.resultsDisclaimer}</p>
          </div>
        </div>
